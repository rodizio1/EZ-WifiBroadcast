...
usage(void)
{
	printf(
	    ...
	    "\n"
	    "Modified version to send out packets in an alternating pattern on wlan0 and wlan1\n"
	    "\n"
	    ...
	    "\n"
	    "Example:\n"
	    "  cat /dev/zero | tx -b 8 -r 4 -f 1024 (reads zeros from stdin and sends them out alternating on wlan0 and wlan1)\n"
